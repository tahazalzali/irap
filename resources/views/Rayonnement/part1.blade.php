<div style="background-image: url('asset('media/ray/Path 34.png')');">
    ...
    <div class="row container m-auto">
        <div class="col-12 col-sm-10 m-auto ">
            ...
            <div style="height: 50px; background-color: #FBBD51; line-height: 50px;">
                <p>Lorem ipsum is</p>
            </div>
            <div class="mt-3">
                <p style="color: #212B59"><strong>Lorem Ipsum is simply dummy text of the printing and </strong> </p>
            </div>
            <div>
                <p style="color:#A6ABA6">Lorem Ipsum is simply dummy text of the printing and
                    typesetting industry. Lorem Ipsum has been the industry's
                    standard dummy text ever since the 1500s, when an</p>
            </div>
            <div>
                <a href="" style="background-color: #FBBD51" class="btn btn-lg text-white m-1 p-3">VOIR L'ADRESSE</a>
            </div>
        </div>
    </div>
    {{-- END DIV 3 --}}
    ...
    <div class="rowcontainer m-auto" style="background-color: #EE7548">
        <div class="col-12 col-sm-10 m-auto ">
            ...
            <div>
                <p style="color:#F7BAA4">Lorem Ipsum is simply dummy text of the printing and
                    typesetting industry. Lorem Ipsum has been the industry's
                    standard dummy text ever since the 1500s, when an</p>
            </div>
            <div>
                <a href="" style="background-color: white; color:#EE7548" class="btn btn-lg m-1 p-3">VOIR L'ADRESSE</a>
            </div>
        </div>
    </div>
    {{-- END DIV 4 --}}
