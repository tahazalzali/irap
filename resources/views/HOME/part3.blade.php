              ...
              <div class="portfolio-wrap">
                ...
                <div class="portfolio-info">
                  ...
                  <div class="portfolio-links">
                    <a href="{{asset('media/home/Mask Group 2.png')}}" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Artisant 1"><i class="bx bx-plus"></i></a>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-decoration">
              <div class="portfolio-wrap">
                ...
                <div class="portfolio-info">
                  ...
                  <p>decoration</p>
                  <div class="portfolio-links">
                    <a href="assets/img/portfolio/portfolio-2.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="decoration 3"><i class="bx bx-plus"></i></a>
                    <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                  </div>
                </div>
              </div>
...
{{-- img  --}}
            <div class="col-lg-4 col-md-6 portfolio-item filter-Artisant">
              <div class="portfolio-wrap">
                ...
                <div class="portfolio-info">
                  ...
                  <p>Artisant</p>
                  <div class="portfolio-links">
                    <a href="{{asset('media/home/3.png')}} " data-gallery="portfolioGallery" class="portfolio-lightbox" title="Artisant 2"><i class="bx bx-plus"></i></a>
                    <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-decoration">
              <div class="portfolio-wrap">
                ...
                <div class="portfolio-info">
                  ...
                  <p>decoration</p>
                  <div class="portfolio-links">
                    <a href="{{asset('media/home/5.png')}} " data-gallery="portfolioGallery" class="portfolio-lightbox" title="decoration 2"><i class="bx bx-plus"></i></a>
                    <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-Artisant">
              <div class="portfolio-wrap">
                ...
                <div class="portfolio-info">
                  ...
                  <p>Artisant</p>
                  <div class="portfolio-links">
                    <a href="{{asset('media/home/6.png')}} " data-gallery="portfolioGallery" class="portfolio-lightbox" title="Artisant 3"><i class="bx bx-plus"></i></a>
                    <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                  </div>
                </div>
              </div>
      ...
      <div class="text-center mb-5">
        <a class="btn text-white btn-lg" href="{{route('products')}}" style=" background-color: #EE7548 ;">VIOR PLUS</a>
    </div>
