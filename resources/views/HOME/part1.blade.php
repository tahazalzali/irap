...
<div style="margin: 0">
<div class="row" style="background: url('{{ asset('media/products/Rectangle 54.png') }}') no-repeat , url('{{ asset('media/home/Group 4.png') }}') no-repeat; min-height:700px;width:100%
 -webkit-background-size: cover;

  background-size: cover;
  margin:0 !important">
    <div class="col-8 m-auto text-center ">
        <h1 style="color: #ffffff"> <strong>61 ANS </strong>EN MISSION</h1>
        ...
        <p class="text-white">Lors du pèlerinage d’un groupe de handicapés du Liban à Lourdes en 1960, deux jeunes
            ...
            Dès le premier jour, tout est placé sous le signe du partage, et cela continue
            jusqu’à maintenant.
        </p>
...
{{-- <div class="row contianer m-auto" style="min-height: 400px">
    ...
    <img src="{{asset("media/home/Group 92.png")}}" class="img-fluid"  alt="">
    ...
    <div>
        <section class="cd-horizontal-timeline" style="padding:0">
            <div class="timeline">
                <div class="events-wrapper">
                    <div class="events">
                        <ol style="  list-style-type: none;">
                            <li><a href="#0" data-date="16/01/2014" class="selected">1960</a></li>
                            <li><a href="#0" data-date="28/02/2014">1963</a></li>
                            <li><a href="#0" data-date="20/04/2014">1975</a></li>
                            <li><a href="#0" data-date="20/05/2014">1980</a></li>
                            <li><a href="#0" data-date="09/07/2014">1980</a></li>
                            <li><a href="#0" data-date="30/08/2014">1990</a></li>
                            <li><a href="#0" data-date="15/09/2014">2000</a></li>
                            <li><a href="#0" data-date="01/11/2014">2005</a></li>
                            <li><a href="#0" data-date="10/12/2014">2010</a></li>
                            <li><a href="#0" data-date="19/01/2015">2015</a></li>
                            <li><a href="#0" data-date="03/03/2015">2020</a></li>
                            <li><a href="#0" data-date="05/04/2015">2022</a></li>
                        </ol>
                ...
                <ul class="cd-timeline-navigation" style="padding: 0;  list-style-type: none;">
